...
from currencies import default_currency_key, local_currency_key
...
def handle_convert_query_with_selected_currency(query: InlineQuery):
...
def handle_convert_query_with_selected_currency_and_target_currency(query: InlineQuery):
