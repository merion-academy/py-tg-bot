...
/survey - опрос
/programming_survey - опрос для программистов
"""
...
random_message_text = formatting.format_text(
    "Сообщение с рандомом",
)

# programming survey

programming_survey_start_ask_full_name = formatting.format_text(
    "Добро пожаловать в наш опрос о программировании!"
    " Мы зададим несколько вопросов.",
    "",
    "Пожалуйста, представьтесь. Как вас зовут?",
    survey_cancel_suggestion,
)
programming_survey_message_cancelled = formatting.format_text(
    "Опрос отменён. Пройти заново: /programming_survey"
)
programming_survey_message_full_name_ok_and_ask_for_programming_language = (
    formatting.format_text(
        "Приятно познакомиться, {full_name}!",
        "Какой у вас любимый язык программирования?",
        "Выберите или напишите свой",
    )
)
programming_survey_message_programming_language_ok_ask_experience_years = (
    formatting.format_text(
        "Класс!",
        "А сколько лет опыта?",
    )
)
programming_survey_message_programming_language_not_text = formatting.format_text(
    "Не понимаю. Какой у вас любимый язык программирования?",
    "Выберите или напишите свой",
)
programming_survey_message_invalid_experience_number = formatting.format_text(
    "Пожалуйста, укажите цифрами сколько у вас лет опыта."
)
programming_survey_message_experience_number_ok_do_you_freelance = (
    formatting.format_text("Увлекаетесь фрилансом?")
)

programming_survey_freelance_me_too = formatting.format_text(
    "Класс! Мы это ценим 🙂",
)

programming_survey_freelance_its_okay = formatting.format_text(
    "Хорошо. Получается, остаётся время на хобби!",
)
