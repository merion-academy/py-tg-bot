...
/set_my_currency RUB - установить целевую валюту RUB для конвертации по /cvt 
"""
...
set_my_currency_help_message = formatting.format_text(
    "Необходимо указать целевую валюту, например:",
    formatting.hcode("/set_my_currency RUB"),
)
set_my_currency_success_message = "Целевая валюта {currency} указана успешно!"
